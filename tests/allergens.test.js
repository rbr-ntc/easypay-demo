...
import { ALLERGENS, allergensFor, dietTagsOf, isAllergen, possibleAllergensFor } from '../shared/allergens.js'

const MENU = JSON.parse(readFileSync(new URL('../src/menu.json', import.meta.url), 'utf8'))
